...
func TestKrypter(t *testing.T) {
	...
	tests := []test{
		...
		{inputMessage: []rune("Kjevik;SN39040;18.03.2022 01:50;6"), chiffer: 4, want: []rune("OnizmocWR7D484c5C 47 6466d45b94cA")},
		{inputMessage: []rune("OnizmocWR7D484c5C 47 6466d45b94cA"), chiffer: len(ALF_SEM03) - 4, want: []rune("Kjevik;SN39040;18.03.2022 01:50;6")},
	}
